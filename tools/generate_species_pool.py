...
def main():
    ...
    lines = [
        ...
        ";",
        "; Valid randomizer species, sorted by base-stat total and split into",
        f"; {NUM_BUCKETS} buckets. The randomizer shuffles within a bucket so",
        "; replacements stay roughly power-matched.",
        "",
